...
const promptProcessor_1 = require("./lib/promptProcessor");
...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield fs.mkdir(OUTPUT_DIR, { recursive: true });
            ...
            const files = yield (0, glob_1.glob)('**/*.md', { cwd: PROMPTS_DIR, absolute: true });
            ...
            for (const filePath of files) {
                ...
                try {
                    const processedContent = yield (0, promptProcessor_1.processPromptFile)(filePath, PROMPTS_DIR);
                    ...
                    yield fs.writeFile(outputPath, processedContent, 'utf-8');
